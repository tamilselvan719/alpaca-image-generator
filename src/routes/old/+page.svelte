...
<div class="flex flex-col sm:flex-row w-full pt-4 gap-4 gap-y-14">
	<div id="alpaca-avatar" class="flex flex-col basis-[400px] shrink-0 gap-2">
		<div class="h-[400px] w-[400px]">
			{#each alpacaImageParts as part}
				<img
					class="absolute w-auto h-[400px]"
